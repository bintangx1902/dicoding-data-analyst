...
all_df = pd.read_csv("https://media.githubusercontent.com/media/bintangx1902/dicoding-data-analyst/main/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://media.githubusercontent.com/media/bintangx1902/dicoding-data-analyst/main/geolocation.csv')
...
sns.barplot(x="product_count", y="product_category_name_english", data=sum_order_items_df.head(5), palette="viridis",
            ax=ax[0])
...
sns.barplot(x="product_count", y="product_category_name_english",
            data=sum_order_items_df.sort_values(by="product_count", ascending=True).head(5), palette="viridis",
            ax=ax[1])
